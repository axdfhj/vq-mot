...
def get_args_parser():
    ...
    parser.add_argument('--val-every-epoch', default=10, type=int, help='validation every n train epoch')
    parser.add_argument('--epoch', default=600, type=int, help='training epochs')
    parser.add_argument('--h36m', action='store_true', help='if --h36m add h36m and text generated by blip2')
